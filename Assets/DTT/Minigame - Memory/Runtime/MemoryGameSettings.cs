...
using DTT.Runtime.ShuffleAlgorithms;
using UnityEngine;

namespace DTT.Runtime
{
    /// <summary>
    ...
    public class MemoryGameSettings : ScriptableObject
    {
        ...
        private ShuffleAlgorithms.ShuffleAlgorithms _shuffleAlgorithm;
        ...
        private void Reset()
        {
            _shuffleAlgorithm = ShuffleAlgorithms.ShuffleAlgorithms.FISHER_YATES;
        ...
        private IShuffleAlgorithm GetAlgorithm()
        {
            ...
            {
                case ShuffleAlgorithms.ShuffleAlgorithms.FISHER_YATES:
                    algorithm = new FisherYatesShuffleAlgorithm();
                    break;

                case ShuffleAlgorithms.ShuffleAlgorithms.KNUTHS_SHUFFLE:
                    algorithm = new KnuthShuffleAlgorithm();
                    break;

                case ShuffleAlgorithms.ShuffleAlgorithms.ASSIGNED_VALUE:
