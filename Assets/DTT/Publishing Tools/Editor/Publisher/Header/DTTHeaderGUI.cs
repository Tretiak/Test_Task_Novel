...
using System.IO;
using DTT.Editor_Utilities.Editor.GUI;
using DTT.Publishing_Tools.Editor.GUI;
using DTT.Publishing_Tools.Editor.Settings;
using DTT.Runtime_Utilities.Runtime.Extensions;
using UnityEditor;
using UnityEngine;

namespace DTT.Publishing_Tools.Editor.Publisher.Header
{
    /// <summary>
    ...
    public class DTTHeaderGUI
    {
        ...
        private void DrawIcon(Rect initRect)
        {
            ...
            if (_customIcon != null)
            {
                UnityEngine.GUI.DrawTexture(iconRect, _customIcon);
            }
            else
            {
                EditorGUI.DrawRect(iconRect, DTTColors.DTTRed);
                UnityEngine.GUI.DrawTexture(iconRect, DTTTextures.icon);
            }
        }
        ...
        private void DrawTitle(Rect initRect)
        {
            ...
            UnityEngine.GUI.Label(titleRect, _content.PackageNameLabel, _styles.TitleLabel);
        }
        ...
        private void DrawVersion(Rect initRect)
        {
            ...
            UnityEngine.GUI.Label(versionRect, _content.VersionLabel, _styles.Label);
        }
        #endregion
        #endregion
    }
