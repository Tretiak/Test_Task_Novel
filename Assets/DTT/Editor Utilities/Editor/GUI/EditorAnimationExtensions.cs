...
namespace DTT.Editor_Utilities.Editor.GUI
{
    ...
    public static class EditorAnimationExtensions
    {
        ...
        public static void DrawAnimatedFoldout(this UnityEditor.Editor editor, string headerName, Action drawAction)
        {
        ...
        public static bool DrawAnimatedToggleFoldout(this UnityEditor.Editor editor, string headerName, bool toggle, Action drawAction)
        {
            // Don't draw anything if either the editor or header name is null.
            if (headerName == null || editor == null)
                return false;
